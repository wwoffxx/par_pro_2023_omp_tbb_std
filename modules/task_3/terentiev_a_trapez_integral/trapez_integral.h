...
#ifndef MODULES_TASK_3_TERENTIEV_A_TRAPEZ_INTEGRAL_TRAPEZ_INTEGRAL_H_
#define MODULES_TASK_3_TERENTIEV_A_TRAPEZ_INTEGRAL_TRAPEZ_INTEGRAL_H_
...
double TrapezIntegral3DParallel(double fromX, double fromY, double fromZ, double toX,
                        double toY, double toZ, int steps,
                        double (*func)(double, double, double));

#endif  // MODULES_TASK_3_TERENTIEV_A_TRAPEZ_INTEGRAL_TRAPEZ_INTEGRAL_H_
