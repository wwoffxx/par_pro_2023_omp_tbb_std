...
TEST(Trapezoidal_Rule_tbb, Test1) {
    int n = 2;
    int p = 10;
...
TEST(Trapezoidal_Rule_tbb, Test2) {
    int n = 2;
    int p = 10;
    std::vector<std::pair<double, double>> front(n);
    front[0] = { 0, 3.14 };
...
TEST(Trapezoidal_Rule_tbb, Test3) {
    int n = 3;
    std::vector<std::pair<double, double>> front(n);
    int p = 10;
    front[0] = { 0, 1 };
...
TEST(Trapezoidal_Rule_tbb, Test4) {
    int n = 3;
    std::vector<std::pair<double, double>> front(n);
    int p = 10;
    front[0] = { 0, 2 };
...
TEST(Trapezoidal_Rule_tbb, Test5) {
    int n = 3;
    std::vector<std::pair<double, double>> front(n);
    int p = 10;
    front[0] = { 1, 4 };
