...
TEST(SobelFilterTBB, matrix_1000_on_1000) {
    int size = 1000;
    Img image(size, size, 1);
    double start;
    double end;
...
TEST(SobelFilterTBB, random_matrix_100_on_100) {
    int size = 100;
    Img image(size, size);
    double start;
    double end;
...
TEST(SobelFilterTBB, random_matrix_500_on_500) {
    int size = 500;
    Img image(size, size);
    double start;
    double end;
...
TEST(SobelFilterTBB, random_matrix_1000_on_1000) {
    int size = 1000;
    Img image(size, size);
    double start;
    double end;
