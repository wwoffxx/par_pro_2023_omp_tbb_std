...
TEST(Parallel_Operations_TBB, Test_Integral) {
    testIntegral(foo1);
}

TEST(Parallel_Operations_TBB, Test_Integral_2) {
    testIntegral(foo2);
}


TEST(Parallel_Operations_TBB, Test_Integral_3) {
    testIntegral(foo3);
}


TEST(Parallel_Operations_TBB, Test_Integral_4) {
    testIntegral(foo4);
}


TEST(Parallel_Operations_TBB, Test_Integral_5) {
    testIntegral(foo5);
}
