...
TEST(binko_a_batchersort, parallel_sort) {
...
TEST(binko_a_batchersort, parallel_sort_eq_sequence_v1) {
...
TEST(binko_a_batchersort, parallel_sort_eq_sequence_v2) {
...
TEST(binko_a_batchersort, parallel_sort_eq_sequence_v3) {
...
TEST(binko_a_batchersort, parallel_sort_faster_sequence) {
