...
#ifndef MODULES_TASK_2_VARYZGIN_D_STRASSEN_STRASSEN_H_
#define MODULES_TASK_2_VARYZGIN_D_STRASSEN_STRASSEN_H_
#include <omp.h>
#include <iostream>
#include <random>
#include <vector>
...
std::vector<double> strassenOmp(const std::vector<double>& A,
                                  const std::vector<double>& B, std::size_t n);

#endif  // MODULES_TASK_2_VARYZGIN_D_STRASSEN_STRASSEN_H_
