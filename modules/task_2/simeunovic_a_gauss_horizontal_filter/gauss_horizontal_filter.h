...
#ifndef MODULES_TASK_2_SIMEUNOVIC_A_GAUSS_HORIZONTAL_FILTER_GAUSS_HORIZONTAL_FILTER_H_
#define MODULES_TASK_2_SIMEUNOVIC_A_GAUSS_HORIZONTAL_FILTER_GAUSS_HORIZONTAL_FILTER_H_
#include <cstdint>
#include <cmath>
#include <ctime>
#include <vector>
