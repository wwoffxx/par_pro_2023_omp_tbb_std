...
std::vector<int> getDijkstra(const std::vector<std::vector<int>>& graf, const int top);
std::vector<int> getSequentialDijkstra(const std::vector<std::vector<int>>& graf);
