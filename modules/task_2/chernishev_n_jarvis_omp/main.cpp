...
#include "./chernishev_n_jarvis_omp.h"

TEST(OMP, Test_OMP_Jarvis_30) {
    std::vector<dot> vec{
    ...
    std::vector<dot> ompRes = JarvisOMP(vec, 5);
    EXPECT_TRUE(isEqual(ompRes, res));
}

TEST(OMP, Test_OMP_Jarvis_10) {
    std::vector<dot> vec{
