...
void testIntegral(IntegralFunction func, double result) {
    double sequential = integrateSequential(func, a, b, n);
    ASSERT_NEAR(sequential, result, epsilon);
}

TEST(Sequential_Operations, Test_Integral) {
    testIntegral(foo1, 1.0);
}

TEST(Sequential_Operations, Test_Integral_2) {
    testIntegral(foo2, 3.375);
}

TEST(Sequential_Operations, Test_Integral_3) {
    testIntegral(foo3, -1.500);
}


TEST(Sequential_Operations, Test_Integral_4) {
    testIntegral(foo4, 11.762);
}


TEST(Sequential_Operations, Test_Integral_5) {
    testIntegral(foo5, 5.524);
}
