...
TEST(Monte_Carlo_std, Test_one_dimension) {
    ...
    double calc_value_integral_std = getIntegralMonteCarloStd(f, a, b, number_points);
    double error = std::abs(calc_value_integral - calc_value_integral_std) / std::abs(calc_value_integral);
