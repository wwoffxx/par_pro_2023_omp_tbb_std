...
TEST(Parallel_Sort_Std, Test_Sort_With_1000000_Random_Elements) {
    int size = 1000000;
...
TEST(Parallel_Sort_Std, Test_Sort_With_10000_Only_Positive_Elements) {
    int size = 10000;
...
TEST(Parallel_Sort_Std, Test_Sort_With_10000_Only_Negative_Elements) {
    int size = 10000;
...
TEST(Parallel_Sort_Std, Test_Sort_With_100000_Positive_and_Negative_Elements) {
    int size = 100000;
...
TEST(Parallel_Sort_Std, Test_Sort_With_1000000_Elements_But_Vector_Already_Sorted) {
    int size = 1000000;
    std::vector<double> vec1 = getRandomVector(size, -10, 10);
    std::vector<double> firstPart = vec1;
    std::vector<double> result;
